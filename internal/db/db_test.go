...
func TestRepoSettingsCRUD(t *testing.T) {
	...
	if err := s.UpsertRepoSettings(RepoSetting{
		Platform: "github", Owner: "djdembeck", Repo: "milmus",
	...
	got, err := s.GetRepoSettings("github", "djdembeck", "milmus")
	if err != nil {
		t.Fatal(err)
	}
	if got == nil {
	...
	if got.Platform != "github" || got.Owner != "djdembeck" || got.Repo != "milmus" {
...
func TestGeneratedNotesRoundTrip(t *testing.T) {
	...
	if err := s.MarkGenerated("github", "djdembeck", "milmus", "rel-1", "v1.0.0", "Notes one"); err != nil {
	...
	if got.Owner != "djdembeck" || got.Repo != "milmus" || got.Platform != "github" {
	...
	if err := s.MarkGenerated("github", "djdembeck", "milmus", "rel-1", "v2.0.0", "Notes two"); err != nil {
